...
WorkflowJobsWorkflowJobsNotificationsListParams contains all the parameters to send to the API endpoint
	...
	for the workflow jobs workflow jobs notifications list operation.
...
// WithDefaults hydrates default values in the workflow jobs workflow jobs notifications list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobsWorkflowJobsNotificationsListParams) WithDefaults() *WorkflowJobsWorkflowJobsNotificationsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the workflow jobs workflow jobs notifications list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobsWorkflowJobsNotificationsListParams) SetDefaults() {
