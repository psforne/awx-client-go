...
HostsHostsGroupsCreateParams contains all the parameters to send to the API endpoint
	...
	for the hosts hosts groups create operation.
...
// WithDefaults hydrates default values in the hosts hosts groups create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsGroupsCreateParams) WithDefaults() *HostsHostsGroupsCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the hosts hosts groups create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsGroupsCreateParams) SetDefaults() {
