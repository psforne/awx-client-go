...
HostsHostsJobHostSummariesListParams contains all the parameters to send to the API endpoint
	...
	for the hosts hosts job host summaries list operation.
...
// WithDefaults hydrates default values in the hosts hosts job host summaries list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsJobHostSummariesListParams) WithDefaults() *HostsHostsJobHostSummariesListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the hosts hosts job host summaries list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsJobHostSummariesListParams) SetDefaults() {
