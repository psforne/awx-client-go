...
HostsHostsSmartInventoriesListParams contains all the parameters to send to the API endpoint
	...
	for the hosts hosts smart inventories list operation.
...
// WithDefaults hydrates default values in the hosts hosts smart inventories list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsSmartInventoriesListParams) WithDefaults() *HostsHostsSmartInventoriesListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the hosts hosts smart inventories list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsSmartInventoriesListParams) SetDefaults() {
