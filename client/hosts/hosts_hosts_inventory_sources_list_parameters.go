...
HostsHostsInventorySourcesListParams contains all the parameters to send to the API endpoint
	...
	for the hosts hosts inventory sources list operation.
...
// WithDefaults hydrates default values in the hosts hosts inventory sources list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsInventorySourcesListParams) WithDefaults() *HostsHostsInventorySourcesListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the hosts hosts inventory sources list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsInventorySourcesListParams) SetDefaults() {
