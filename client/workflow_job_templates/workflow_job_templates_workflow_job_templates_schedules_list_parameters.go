...
WorkflowJobTemplatesWorkflowJobTemplatesSchedulesListParams contains all the parameters to send to the API endpoint
	...
	for the workflow job templates workflow job templates schedules list operation.
...
// WithDefaults hydrates default values in the workflow job templates workflow job templates schedules list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobTemplatesWorkflowJobTemplatesSchedulesListParams) WithDefaults() *WorkflowJobTemplatesWorkflowJobTemplatesSchedulesListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the workflow job templates workflow job templates schedules list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobTemplatesWorkflowJobTemplatesSchedulesListParams) SetDefaults() {
