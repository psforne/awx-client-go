...
TeamsTeamsUpdateParams contains all the parameters to send to the API endpoint
	...
	for the teams teams update operation.
...
// WithDefaults hydrates default values in the teams teams update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsUpdateParams) WithDefaults() *TeamsTeamsUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the teams teams update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsUpdateParams) SetDefaults() {
