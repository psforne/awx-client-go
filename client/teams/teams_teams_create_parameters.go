...
TeamsTeamsCreateParams contains all the parameters to send to the API endpoint
	...
	for the teams teams create operation.
...
// WithDefaults hydrates default values in the teams teams create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsCreateParams) WithDefaults() *TeamsTeamsCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the teams teams create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsCreateParams) SetDefaults() {
