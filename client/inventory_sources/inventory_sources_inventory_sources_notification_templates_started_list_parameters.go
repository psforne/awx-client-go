...
InventorySourcesInventorySourcesNotificationTemplatesStartedListParams contains all the parameters to send to the API endpoint
	...
	for the inventory sources inventory sources notification templates started list operation.
...
// WithDefaults hydrates default values in the inventory sources inventory sources notification templates started list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InventorySourcesInventorySourcesNotificationTemplatesStartedListParams) WithDefaults() *InventorySourcesInventorySourcesNotificationTemplatesStartedListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the inventory sources inventory sources notification templates started list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InventorySourcesInventorySourcesNotificationTemplatesStartedListParams) SetDefaults() {
