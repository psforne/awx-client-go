...
type ClientService interface {
	ProjectUpdatesProjectUpdatesCancelCreate(params *ProjectUpdatesProjectUpdatesCancelCreateParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesCancelCreateCreated, error)

	ProjectUpdatesProjectUpdatesCancelRead(params *ProjectUpdatesProjectUpdatesCancelReadParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesCancelReadOK, error)

	ProjectUpdatesProjectUpdatesDelete(params *ProjectUpdatesProjectUpdatesDeleteParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesDeleteNoContent, error)

	ProjectUpdatesProjectUpdatesEventsList(params *ProjectUpdatesProjectUpdatesEventsListParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesEventsListOK, error)

	ProjectUpdatesProjectUpdatesList(params *ProjectUpdatesProjectUpdatesListParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesListOK, error)

	ProjectUpdatesProjectUpdatesNotificationsList(params *ProjectUpdatesProjectUpdatesNotificationsListParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesNotificationsListOK, error)

	ProjectUpdatesProjectUpdatesRead(params *ProjectUpdatesProjectUpdatesReadParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesReadOK, error)

	ProjectUpdatesProjectUpdatesScmInventoryUpdatesList(params *ProjectUpdatesProjectUpdatesScmInventoryUpdatesListParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesScmInventoryUpdatesListOK, error)

	ProjectUpdatesProjectUpdatesStdoutRead(params *ProjectUpdatesProjectUpdatesStdoutReadParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesStdoutReadOK, error)
...
*/
func (a *Client) ProjectUpdatesProjectUpdatesCancelCreate(params *ProjectUpdatesProjectUpdatesCancelCreateParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesCancelCreateCreated, error) {
...
update cannot be canceled.
*/
func (a *Client) ProjectUpdatesProjectUpdatesCancelRead(params *ProjectUpdatesProjectUpdatesCancelReadParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesCancelReadOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ProjectUpdatesProjectUpdatesDelete(params *ProjectUpdatesProjectUpdatesDeleteParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesDeleteNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ProjectUpdatesProjectUpdatesEventsList(params *ProjectUpdatesProjectUpdatesEventsListParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesEventsListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) ProjectUpdatesProjectUpdatesList(params *ProjectUpdatesProjectUpdatesListParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) ProjectUpdatesProjectUpdatesNotificationsList(params *ProjectUpdatesProjectUpdatesNotificationsListParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesNotificationsListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ProjectUpdatesProjectUpdatesRead(params *ProjectUpdatesProjectUpdatesReadParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesReadOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) ProjectUpdatesProjectUpdatesScmInventoryUpdatesList(params *ProjectUpdatesProjectUpdatesScmInventoryUpdatesListParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesScmInventoryUpdatesListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) ProjectUpdatesProjectUpdatesStdoutRead(params *ProjectUpdatesProjectUpdatesStdoutReadParams, opts ...ClientOption) (*ProjectUpdatesProjectUpdatesStdoutReadOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
