...
LabelsLabelsUpdateParams contains all the parameters to send to the API endpoint
	...
	for the labels labels update operation.
...
// WithDefaults hydrates default values in the labels labels update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LabelsLabelsUpdateParams) WithDefaults() *LabelsLabelsUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the labels labels update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *LabelsLabelsUpdateParams) SetDefaults() {
