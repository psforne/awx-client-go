...
JobsJobsCredentialsListParams contains all the parameters to send to the API endpoint
	...
	for the jobs jobs credentials list operation.
...
// WithDefaults hydrates default values in the jobs jobs credentials list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobsJobsCredentialsListParams) WithDefaults() *JobsJobsCredentialsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the jobs jobs credentials list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobsJobsCredentialsListParams) SetDefaults() {
