...
CredentialTypesCredentialTypesActivityStreamListParams contains all the parameters to send to the API endpoint
	...
	for the credential types credential types activity stream list operation.
...
// WithDefaults hydrates default values in the credential types credential types activity stream list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialTypesCredentialTypesActivityStreamListParams) WithDefaults() *CredentialTypesCredentialTypesActivityStreamListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the credential types credential types activity stream list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialTypesCredentialTypesActivityStreamListParams) SetDefaults() {
