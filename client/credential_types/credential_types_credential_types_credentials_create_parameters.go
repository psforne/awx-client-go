...
CredentialTypesCredentialTypesCredentialsCreateParams contains all the parameters to send to the API endpoint
	...
	for the credential types credential types credentials create operation.
...
// WithDefaults hydrates default values in the credential types credential types credentials create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialTypesCredentialTypesCredentialsCreateParams) WithDefaults() *CredentialTypesCredentialTypesCredentialsCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the credential types credential types credentials create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialTypesCredentialTypesCredentialsCreateParams) SetDefaults() {
