...
CredentialTypesCredentialTypesUpdateParams contains all the parameters to send to the API endpoint
	...
	for the credential types credential types update operation.
...
// WithDefaults hydrates default values in the credential types credential types update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialTypesCredentialTypesUpdateParams) WithDefaults() *CredentialTypesCredentialTypesUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the credential types credential types update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialTypesCredentialTypesUpdateParams) SetDefaults() {
