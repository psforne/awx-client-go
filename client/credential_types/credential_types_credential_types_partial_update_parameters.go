...
CredentialTypesCredentialTypesPartialUpdateParams contains all the parameters to send to the API endpoint
	...
	for the credential types credential types partial update operation.
...
// WithDefaults hydrates default values in the credential types credential types partial update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialTypesCredentialTypesPartialUpdateParams) WithDefaults() *CredentialTypesCredentialTypesPartialUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the credential types credential types partial update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialTypesCredentialTypesPartialUpdateParams) SetDefaults() {
