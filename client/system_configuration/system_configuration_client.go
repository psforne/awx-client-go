...
type ClientService interface {
	SystemConfigurationAuthList(params *SystemConfigurationAuthListParams, opts ...ClientOption) (*SystemConfigurationAuthListOK, error)

	SystemConfigurationConfigAttachCreate(params *SystemConfigurationConfigAttachCreateParams, opts ...ClientOption) (*SystemConfigurationConfigAttachCreateCreated, error)

	SystemConfigurationConfigCreate(params *SystemConfigurationConfigCreateParams, opts ...ClientOption) (*SystemConfigurationConfigCreateCreated, error)

	SystemConfigurationConfigDelete(params *SystemConfigurationConfigDeleteParams, opts ...ClientOption) (*SystemConfigurationConfigDeleteNoContent, error)

	SystemConfigurationConfigList(params *SystemConfigurationConfigListParams, opts ...ClientOption) (*SystemConfigurationConfigListOK, error)

	SystemConfigurationConfigSubscriptionsCreate(params *SystemConfigurationConfigSubscriptionsCreateParams, opts ...ClientOption) (*SystemConfigurationConfigSubscriptionsCreateCreated, error)

	SystemConfigurationPingList(params *SystemConfigurationPingListParams, opts ...ClientOption) (*SystemConfigurationPingListOK, error)
...
*/
func (a *Client) SystemConfigurationAuthList(params *SystemConfigurationAuthListParams, opts ...ClientOption) (*SystemConfigurationAuthListOK, error) {
...
/*
SystemConfigurationConfigAttachCreate system configuration config attach create API
*/
func (a *Client) SystemConfigurationConfigAttachCreate(params *SystemConfigurationConfigAttachCreateParams, opts ...ClientOption) (*SystemConfigurationConfigAttachCreateCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewSystemConfigurationConfigAttachCreateParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "System Configuration_config_attach_create",
		Method:             "POST",
		PathPattern:        "/api/v2/config/attach/",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &SystemConfigurationConfigAttachCreateReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	success, ok := result.(*SystemConfigurationConfigAttachCreateCreated)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for System Configuration_config_attach_create: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
*/
func (a *Client) SystemConfigurationConfigCreate(params *SystemConfigurationConfigCreateParams, opts ...ClientOption) (*SystemConfigurationConfigCreateCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SystemConfigurationConfigDelete(params *SystemConfigurationConfigDeleteParams, opts ...ClientOption) (*SystemConfigurationConfigDeleteNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SystemConfigurationConfigList(params *SystemConfigurationConfigListParams, opts ...ClientOption) (*SystemConfigurationConfigListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SystemConfigurationConfigSubscriptionsCreate(params *SystemConfigurationConfigSubscriptionsCreateParams, opts ...ClientOption) (*SystemConfigurationConfigSubscriptionsCreateCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SystemConfigurationPingList(params *SystemConfigurationPingListParams, opts ...ClientOption) (*SystemConfigurationPingListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
