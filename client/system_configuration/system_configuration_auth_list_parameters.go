...
SystemConfigurationAuthListParams contains all the parameters to send to the API endpoint
	...
	for the system configuration auth list operation.
...
// WithDefaults hydrates default values in the system configuration auth list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SystemConfigurationAuthListParams) WithDefaults() *SystemConfigurationAuthListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the system configuration auth list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SystemConfigurationAuthListParams) SetDefaults() {
