...
type ClientService interface {
	DashboardDashboardGraphsJobsList(params *DashboardDashboardGraphsJobsListParams, opts ...ClientOption) (*DashboardDashboardGraphsJobsListOK, error)

	DashboardDashboardList(params *DashboardDashboardListParams, opts ...ClientOption) (*DashboardDashboardListOK, error)
...
*/
func (a *Client) DashboardDashboardGraphsJobsList(params *DashboardDashboardGraphsJobsListParams, opts ...ClientOption) (*DashboardDashboardGraphsJobsListOK, error) {
...
*/
func (a *Client) DashboardDashboardList(params *DashboardDashboardListParams, opts ...ClientOption) (*DashboardDashboardListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
