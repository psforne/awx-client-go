...
MetricsMetricsListParams contains all the parameters to send to the API endpoint
	...
	for the metrics metrics list operation.
...
// WithDefaults hydrates default values in the metrics metrics list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *MetricsMetricsListParams) WithDefaults() *MetricsMetricsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the metrics metrics list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *MetricsMetricsListParams) SetDefaults() {
