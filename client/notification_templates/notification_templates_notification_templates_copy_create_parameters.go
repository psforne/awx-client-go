...
NotificationTemplatesNotificationTemplatesCopyCreateParams contains all the parameters to send to the API endpoint
	...
	for the notification templates notification templates copy create operation.
...
// WithDefaults hydrates default values in the notification templates notification templates copy create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *NotificationTemplatesNotificationTemplatesCopyCreateParams) WithDefaults() *NotificationTemplatesNotificationTemplatesCopyCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the notification templates notification templates copy create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *NotificationTemplatesNotificationTemplatesCopyCreateParams) SetDefaults() {
