...
/*
NotificationTemplatesNotificationTemplatesUpdateOK describes a response with status code 200, with default header values.

NotificationTemplatesNotificationTemplatesUpdateOK notification templates notification templates update o k
*/
type NotificationTemplatesNotificationTemplatesUpdateOK struct {
}

// IsSuccess returns true when this notification templates notification templates update o k response has a 2xx status code
func (o *NotificationTemplatesNotificationTemplatesUpdateOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this notification templates notification templates update o k response has a 3xx status code
func (o *NotificationTemplatesNotificationTemplatesUpdateOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this notification templates notification templates update o k response has a 4xx status code
func (o *NotificationTemplatesNotificationTemplatesUpdateOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this notification templates notification templates update o k response has a 5xx status code
func (o *NotificationTemplatesNotificationTemplatesUpdateOK) IsServerError() bool {
	return false
}

// IsCode returns true when this notification templates notification templates update o k response a status code equal to that given
func (o *NotificationTemplatesNotificationTemplatesUpdateOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *NotificationTemplatesNotificationTemplatesUpdateOK) String() string {
	return fmt.Sprintf("[PUT /api/v2/notification_templates/{id}/][%d] notificationTemplatesNotificationTemplatesUpdateOK ", 200)
}
...
// ContextValidate validates this notification templates notification templates update body based on context it is used
func (o *NotificationTemplatesNotificationTemplatesUpdateBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
