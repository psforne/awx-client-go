...
JobTemplatesJobTemplatesReadParams contains all the parameters to send to the API endpoint
	...
	for the job templates job templates read operation.
...
// WithDefaults hydrates default values in the job templates job templates read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesReadParams) WithDefaults() *JobTemplatesJobTemplatesReadParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job templates job templates read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesReadParams) SetDefaults() {
