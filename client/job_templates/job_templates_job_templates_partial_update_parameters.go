...
JobTemplatesJobTemplatesPartialUpdateParams contains all the parameters to send to the API endpoint
	...
	for the job templates job templates partial update operation.
...
// WithDefaults hydrates default values in the job templates job templates partial update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesPartialUpdateParams) WithDefaults() *JobTemplatesJobTemplatesPartialUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job templates job templates partial update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesPartialUpdateParams) SetDefaults() {
