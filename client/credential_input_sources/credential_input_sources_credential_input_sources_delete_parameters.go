...
CredentialInputSourcesCredentialInputSourcesDeleteParams contains all the parameters to send to the API endpoint
	...
	for the credential input sources credential input sources delete operation.
...
// WithDefaults hydrates default values in the credential input sources credential input sources delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialInputSourcesCredentialInputSourcesDeleteParams) WithDefaults() *CredentialInputSourcesCredentialInputSourcesDeleteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the credential input sources credential input sources delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialInputSourcesCredentialInputSourcesDeleteParams) SetDefaults() {
