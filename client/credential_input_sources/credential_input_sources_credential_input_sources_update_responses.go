...
/*
CredentialInputSourcesCredentialInputSourcesUpdateOK describes a response with status code 200, with default header values.

CredentialInputSourcesCredentialInputSourcesUpdateOK credential input sources credential input sources update o k
*/
type CredentialInputSourcesCredentialInputSourcesUpdateOK struct {
}

// IsSuccess returns true when this credential input sources credential input sources update o k response has a 2xx status code
func (o *CredentialInputSourcesCredentialInputSourcesUpdateOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this credential input sources credential input sources update o k response has a 3xx status code
func (o *CredentialInputSourcesCredentialInputSourcesUpdateOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this credential input sources credential input sources update o k response has a 4xx status code
func (o *CredentialInputSourcesCredentialInputSourcesUpdateOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this credential input sources credential input sources update o k response has a 5xx status code
func (o *CredentialInputSourcesCredentialInputSourcesUpdateOK) IsServerError() bool {
	return false
}

// IsCode returns true when this credential input sources credential input sources update o k response a status code equal to that given
func (o *CredentialInputSourcesCredentialInputSourcesUpdateOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *CredentialInputSourcesCredentialInputSourcesUpdateOK) String() string {
	return fmt.Sprintf("[PUT /api/v2/credential_input_sources/{id}/][%d] credentialInputSourcesCredentialInputSourcesUpdateOK ", 200)
}
...
// ContextValidate validates this credential input sources credential input sources update body based on context it is used
func (o *CredentialInputSourcesCredentialInputSourcesUpdateBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
