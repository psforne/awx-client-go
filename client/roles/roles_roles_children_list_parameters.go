...
RolesRolesChildrenListParams contains all the parameters to send to the API endpoint
	...
	for the roles roles children list operation.
...
// WithDefaults hydrates default values in the roles roles children list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *RolesRolesChildrenListParams) WithDefaults() *RolesRolesChildrenListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the roles roles children list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *RolesRolesChildrenListParams) SetDefaults() {
