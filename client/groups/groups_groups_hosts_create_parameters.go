...
GroupsGroupsHostsCreateParams contains all the parameters to send to the API endpoint
	...
	for the groups groups hosts create operation.
...
// WithDefaults hydrates default values in the groups groups hosts create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GroupsGroupsHostsCreateParams) WithDefaults() *GroupsGroupsHostsCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the groups groups hosts create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GroupsGroupsHostsCreateParams) SetDefaults() {
