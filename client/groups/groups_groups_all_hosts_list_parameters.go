...
GroupsGroupsAllHostsListParams contains all the parameters to send to the API endpoint
	...
	for the groups groups all hosts list operation.
...
// WithDefaults hydrates default values in the groups groups all hosts list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GroupsGroupsAllHostsListParams) WithDefaults() *GroupsGroupsAllHostsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the groups groups all hosts list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GroupsGroupsAllHostsListParams) SetDefaults() {
