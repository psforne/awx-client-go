...
GroupsGroupsUpdateParams contains all the parameters to send to the API endpoint
	...
	for the groups groups update operation.
...
// WithDefaults hydrates default values in the groups groups update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GroupsGroupsUpdateParams) WithDefaults() *GroupsGroupsUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the groups groups update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GroupsGroupsUpdateParams) SetDefaults() {
