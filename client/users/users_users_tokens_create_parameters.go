...
UsersUsersTokensCreateParams contains all the parameters to send to the API endpoint
	...
	for the users users tokens create operation.
...
// WithDefaults hydrates default values in the users users tokens create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersTokensCreateParams) WithDefaults() *UsersUsersTokensCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the users users tokens create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersTokensCreateParams) SetDefaults() {
