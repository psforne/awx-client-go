...
UsersUsersPersonalTokensCreateParams contains all the parameters to send to the API endpoint
	...
	for the users users personal tokens create operation.
...
// WithDefaults hydrates default values in the users users personal tokens create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersPersonalTokensCreateParams) WithDefaults() *UsersUsersPersonalTokensCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the users users personal tokens create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersPersonalTokensCreateParams) SetDefaults() {
