...
UsersUsersActivityStreamListParams contains all the parameters to send to the API endpoint
	...
	for the users users activity stream list operation.
...
// WithDefaults hydrates default values in the users users activity stream list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersActivityStreamListParams) WithDefaults() *UsersUsersActivityStreamListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the users users activity stream list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersActivityStreamListParams) SetDefaults() {
