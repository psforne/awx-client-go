...
UsersUsersCredentialsCreateParams contains all the parameters to send to the API endpoint
	...
	for the users users credentials create operation.
...
// WithDefaults hydrates default values in the users users credentials create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersCredentialsCreateParams) WithDefaults() *UsersUsersCredentialsCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the users users credentials create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersCredentialsCreateParams) SetDefaults() {
