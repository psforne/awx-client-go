...
UsersUsersTeamsListParams contains all the parameters to send to the API endpoint
	...
	for the users users teams list operation.
...
// WithDefaults hydrates default values in the users users teams list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersTeamsListParams) WithDefaults() *UsersUsersTeamsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the users users teams list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersTeamsListParams) SetDefaults() {
