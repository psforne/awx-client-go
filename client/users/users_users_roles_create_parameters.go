...
UsersUsersRolesCreateParams contains all the parameters to send to the API endpoint
	...
	for the users users roles create operation.
...
// WithDefaults hydrates default values in the users users roles create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersRolesCreateParams) WithDefaults() *UsersUsersRolesCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the users users roles create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersRolesCreateParams) SetDefaults() {
