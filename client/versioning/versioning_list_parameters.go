...
VersioningListParams contains all the parameters to send to the API endpoint
	...
	for the versioning list operation.
...
// WithDefaults hydrates default values in the versioning list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *VersioningListParams) WithDefaults() *VersioningListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the versioning list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *VersioningListParams) SetDefaults() {
