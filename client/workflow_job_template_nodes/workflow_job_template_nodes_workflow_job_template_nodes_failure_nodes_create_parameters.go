...
WorkflowJobTemplateNodesWorkflowJobTemplateNodesFailureNodesCreateParams contains all the parameters to send to the API endpoint
	...
	for the workflow job template nodes workflow job template nodes failure nodes create operation.
...
// WithDefaults hydrates default values in the workflow job template nodes workflow job template nodes failure nodes create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobTemplateNodesWorkflowJobTemplateNodesFailureNodesCreateParams) WithDefaults() *WorkflowJobTemplateNodesWorkflowJobTemplateNodesFailureNodesCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the workflow job template nodes workflow job template nodes failure nodes create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobTemplateNodesWorkflowJobTemplateNodesFailureNodesCreateParams) SetDefaults() {
