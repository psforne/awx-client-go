...
WorkflowJobTemplateNodesWorkflowJobTemplateNodesFailureNodesListParams contains all the parameters to send to the API endpoint
	...
	for the workflow job template nodes workflow job template nodes failure nodes list operation.
...
// WithDefaults hydrates default values in the workflow job template nodes workflow job template nodes failure nodes list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobTemplateNodesWorkflowJobTemplateNodesFailureNodesListParams) WithDefaults() *WorkflowJobTemplateNodesWorkflowJobTemplateNodesFailureNodesListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the workflow job template nodes workflow job template nodes failure nodes list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobTemplateNodesWorkflowJobTemplateNodesFailureNodesListParams) SetDefaults() {
