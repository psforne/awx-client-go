...
ProjectsProjectsInventoriesReadParams contains all the parameters to send to the API endpoint
	...
	for the projects projects inventories read operation.
...
// WithDefaults hydrates default values in the projects projects inventories read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProjectsProjectsInventoriesReadParams) WithDefaults() *ProjectsProjectsInventoriesReadParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the projects projects inventories read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProjectsProjectsInventoriesReadParams) SetDefaults() {
