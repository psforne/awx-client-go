...
ProjectsProjectsCopyCreateParams contains all the parameters to send to the API endpoint
	...
	for the projects projects copy create operation.
...
// WithDefaults hydrates default values in the projects projects copy create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProjectsProjectsCopyCreateParams) WithDefaults() *ProjectsProjectsCopyCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the projects projects copy create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProjectsProjectsCopyCreateParams) SetDefaults() {
