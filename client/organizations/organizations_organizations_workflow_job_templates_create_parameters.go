...
OrganizationsOrganizationsWorkflowJobTemplatesCreateParams contains all the parameters to send to the API endpoint
	...
	for the organizations organizations workflow job templates create operation.
...
// WithDefaults hydrates default values in the organizations organizations workflow job templates create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *OrganizationsOrganizationsWorkflowJobTemplatesCreateParams) WithDefaults() *OrganizationsOrganizationsWorkflowJobTemplatesCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the organizations organizations workflow job templates create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *OrganizationsOrganizationsWorkflowJobTemplatesCreateParams) SetDefaults() {
