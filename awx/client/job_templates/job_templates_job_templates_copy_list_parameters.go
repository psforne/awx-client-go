...
JobTemplatesJobTemplatesCopyListParams contains all the parameters to send to the API endpoint
	...
	for the job templates job templates copy list operation.
...
// WithDefaults hydrates default values in the job templates job templates copy list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesCopyListParams) WithDefaults() *JobTemplatesJobTemplatesCopyListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job templates job templates copy list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesCopyListParams) SetDefaults() {
