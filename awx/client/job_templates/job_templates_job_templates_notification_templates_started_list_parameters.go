...
JobTemplatesJobTemplatesNotificationTemplatesStartedListParams contains all the parameters to send to the API endpoint
	...
	for the job templates job templates notification templates started list operation.
...
// WithDefaults hydrates default values in the job templates job templates notification templates started list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesNotificationTemplatesStartedListParams) WithDefaults() *JobTemplatesJobTemplatesNotificationTemplatesStartedListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job templates job templates notification templates started list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesNotificationTemplatesStartedListParams) SetDefaults() {
