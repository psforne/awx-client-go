...
JobTemplatesJobTemplatesSchedulesCreateParams contains all the parameters to send to the API endpoint
	...
	for the job templates job templates schedules create operation.
...
// WithDefaults hydrates default values in the job templates job templates schedules create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesSchedulesCreateParams) WithDefaults() *JobTemplatesJobTemplatesSchedulesCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job templates job templates schedules create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesSchedulesCreateParams) SetDefaults() {
