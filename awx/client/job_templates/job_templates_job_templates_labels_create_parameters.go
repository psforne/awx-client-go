...
JobTemplatesJobTemplatesLabelsCreateParams contains all the parameters to send to the API endpoint
	...
	for the job templates job templates labels create operation.
...
// WithDefaults hydrates default values in the job templates job templates labels create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesLabelsCreateParams) WithDefaults() *JobTemplatesJobTemplatesLabelsCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job templates job templates labels create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesLabelsCreateParams) SetDefaults() {
