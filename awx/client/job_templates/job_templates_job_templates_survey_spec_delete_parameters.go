...
JobTemplatesJobTemplatesSurveySpecDeleteParams contains all the parameters to send to the API endpoint
	...
	for the job templates job templates survey spec delete operation.
...
// WithDefaults hydrates default values in the job templates job templates survey spec delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesSurveySpecDeleteParams) WithDefaults() *JobTemplatesJobTemplatesSurveySpecDeleteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job templates job templates survey spec delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesSurveySpecDeleteParams) SetDefaults() {
