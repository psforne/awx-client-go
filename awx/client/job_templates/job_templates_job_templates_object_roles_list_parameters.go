...
JobTemplatesJobTemplatesObjectRolesListParams contains all the parameters to send to the API endpoint
	...
	for the job templates job templates object roles list operation.
...
// WithDefaults hydrates default values in the job templates job templates object roles list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesObjectRolesListParams) WithDefaults() *JobTemplatesJobTemplatesObjectRolesListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job templates job templates object roles list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesObjectRolesListParams) SetDefaults() {
