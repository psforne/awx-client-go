...
/*
JobTemplatesJobTemplatesNotificationTemplatesErrorCreateCreated describes a response with status code 201, with default header values.
...
// IsSuccess returns true when this job templates job templates notification templates error create created response has a 2xx status code
func (o *JobTemplatesJobTemplatesNotificationTemplatesErrorCreateCreated) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this job templates job templates notification templates error create created response has a 3xx status code
func (o *JobTemplatesJobTemplatesNotificationTemplatesErrorCreateCreated) IsRedirect() bool {
	return false
}

// IsClientError returns true when this job templates job templates notification templates error create created response has a 4xx status code
func (o *JobTemplatesJobTemplatesNotificationTemplatesErrorCreateCreated) IsClientError() bool {
	return false
}

// IsServerError returns true when this job templates job templates notification templates error create created response has a 5xx status code
func (o *JobTemplatesJobTemplatesNotificationTemplatesErrorCreateCreated) IsServerError() bool {
	return false
}

// IsCode returns true when this job templates job templates notification templates error create created response a status code equal to that given
func (o *JobTemplatesJobTemplatesNotificationTemplatesErrorCreateCreated) IsCode(code int) bool {
	return code == 201
}
...
func (o *JobTemplatesJobTemplatesNotificationTemplatesErrorCreateCreated) String() string {
	return fmt.Sprintf("[POST /api/v2/job_templates/{id}/notification_templates_error/][%d] jobTemplatesJobTemplatesNotificationTemplatesErrorCreateCreated ", 201)
}
...
// ContextValidate validates this job templates job templates notification templates error create body based on context it is used
func (o *JobTemplatesJobTemplatesNotificationTemplatesErrorCreateBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
