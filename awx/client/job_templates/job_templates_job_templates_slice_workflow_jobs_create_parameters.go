...
JobTemplatesJobTemplatesSliceWorkflowJobsCreateParams contains all the parameters to send to the API endpoint
	...
	for the job templates job templates slice workflow jobs create operation.
...
// WithDefaults hydrates default values in the job templates job templates slice workflow jobs create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesSliceWorkflowJobsCreateParams) WithDefaults() *JobTemplatesJobTemplatesSliceWorkflowJobsCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job templates job templates slice workflow jobs create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesSliceWorkflowJobsCreateParams) SetDefaults() {
