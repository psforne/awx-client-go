...
JobTemplatesJobTemplatesLaunchReadParams contains all the parameters to send to the API endpoint
	...
	for the job templates job templates launch read operation.
...
// WithDefaults hydrates default values in the job templates job templates launch read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesLaunchReadParams) WithDefaults() *JobTemplatesJobTemplatesLaunchReadParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job templates job templates launch read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesLaunchReadParams) SetDefaults() {
