...
JobTemplatesJobTemplatesInstanceGroupsListParams contains all the parameters to send to the API endpoint
	...
	for the job templates job templates instance groups list operation.
...
// WithDefaults hydrates default values in the job templates job templates instance groups list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesInstanceGroupsListParams) WithDefaults() *JobTemplatesJobTemplatesInstanceGroupsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job templates job templates instance groups list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesInstanceGroupsListParams) SetDefaults() {
