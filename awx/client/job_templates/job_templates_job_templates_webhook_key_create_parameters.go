...
JobTemplatesJobTemplatesWebhookKeyCreateParams contains all the parameters to send to the API endpoint
	...
	for the job templates job templates webhook key create operation.
...
// WithDefaults hydrates default values in the job templates job templates webhook key create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesWebhookKeyCreateParams) WithDefaults() *JobTemplatesJobTemplatesWebhookKeyCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the job templates job templates webhook key create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobTemplatesJobTemplatesWebhookKeyCreateParams) SetDefaults() {
