...
WorkflowJobTemplatesWorkflowJobTemplatesNotificationTemplatesApprovalsListParams contains all the parameters to send to the API endpoint
	...
	for the workflow job templates workflow job templates notification templates approvals list operation.
...
// WithDefaults hydrates default values in the workflow job templates workflow job templates notification templates approvals list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobTemplatesWorkflowJobTemplatesNotificationTemplatesApprovalsListParams) WithDefaults() *WorkflowJobTemplatesWorkflowJobTemplatesNotificationTemplatesApprovalsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the workflow job templates workflow job templates notification templates approvals list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobTemplatesWorkflowJobTemplatesNotificationTemplatesApprovalsListParams) SetDefaults() {
