...
WorkflowJobTemplatesWorkflowJobTemplatesWebhookKeyListParams contains all the parameters to send to the API endpoint
	...
	for the workflow job templates workflow job templates webhook key list operation.
...
// WithDefaults hydrates default values in the workflow job templates workflow job templates webhook key list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobTemplatesWorkflowJobTemplatesWebhookKeyListParams) WithDefaults() *WorkflowJobTemplatesWorkflowJobTemplatesWebhookKeyListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the workflow job templates workflow job templates webhook key list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobTemplatesWorkflowJobTemplatesWebhookKeyListParams) SetDefaults() {
