...
DashboardDashboardGraphsJobsListParams contains all the parameters to send to the API endpoint
	...
	for the dashboard dashboard graphs jobs list operation.
...
// WithDefaults hydrates default values in the dashboard dashboard graphs jobs list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DashboardDashboardGraphsJobsListParams) WithDefaults() *DashboardDashboardGraphsJobsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the dashboard dashboard graphs jobs list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DashboardDashboardGraphsJobsListParams) SetDefaults() {
