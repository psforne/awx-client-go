...
CredentialTypesCredentialTypesListParams contains all the parameters to send to the API endpoint
	...
	for the credential types credential types list operation.
...
// WithDefaults hydrates default values in the credential types credential types list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialTypesCredentialTypesListParams) WithDefaults() *CredentialTypesCredentialTypesListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the credential types credential types list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialTypesCredentialTypesListParams) SetDefaults() {
