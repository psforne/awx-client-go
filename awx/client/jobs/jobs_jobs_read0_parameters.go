...
JobsJobsRead0Params contains all the parameters to send to the API endpoint
	...
	for the jobs jobs read 0 operation.
...
// WithDefaults hydrates default values in the jobs jobs read 0 params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobsJobsRead0Params) WithDefaults() *JobsJobsRead0Params {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the jobs jobs read 0 params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobsJobsRead0Params) SetDefaults() {
