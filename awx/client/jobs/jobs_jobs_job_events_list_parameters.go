...
JobsJobsJobEventsListParams contains all the parameters to send to the API endpoint
	...
	for the jobs jobs job events list operation.
...
// WithDefaults hydrates default values in the jobs jobs job events list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobsJobsJobEventsListParams) WithDefaults() *JobsJobsJobEventsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the jobs jobs job events list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobsJobsJobEventsListParams) SetDefaults() {
