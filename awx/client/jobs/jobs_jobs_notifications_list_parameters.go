...
JobsJobsNotificationsListParams contains all the parameters to send to the API endpoint
	...
	for the jobs jobs notifications list operation.
...
// WithDefaults hydrates default values in the jobs jobs notifications list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobsJobsNotificationsListParams) WithDefaults() *JobsJobsNotificationsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the jobs jobs notifications list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobsJobsNotificationsListParams) SetDefaults() {
