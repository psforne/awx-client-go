...
JobsJobsStdoutReadParams contains all the parameters to send to the API endpoint
	...
	for the jobs jobs stdout read operation.
...
// WithDefaults hydrates default values in the jobs jobs stdout read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobsJobsStdoutReadParams) WithDefaults() *JobsJobsStdoutReadParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the jobs jobs stdout read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *JobsJobsStdoutReadParams) SetDefaults() {
