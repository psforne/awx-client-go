...
InventoryUpdatesInventoryUpdatesCredentialsListParams contains all the parameters to send to the API endpoint
	...
	for the inventory updates inventory updates credentials list operation.
...
// WithDefaults hydrates default values in the inventory updates inventory updates credentials list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InventoryUpdatesInventoryUpdatesCredentialsListParams) WithDefaults() *InventoryUpdatesInventoryUpdatesCredentialsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the inventory updates inventory updates credentials list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InventoryUpdatesInventoryUpdatesCredentialsListParams) SetDefaults() {
