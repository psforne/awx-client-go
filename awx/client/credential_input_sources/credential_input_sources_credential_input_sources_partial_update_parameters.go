...
CredentialInputSourcesCredentialInputSourcesPartialUpdateParams contains all the parameters to send to the API endpoint
	...
	for the credential input sources credential input sources partial update operation.
...
// WithDefaults hydrates default values in the credential input sources credential input sources partial update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialInputSourcesCredentialInputSourcesPartialUpdateParams) WithDefaults() *CredentialInputSourcesCredentialInputSourcesPartialUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the credential input sources credential input sources partial update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *CredentialInputSourcesCredentialInputSourcesPartialUpdateParams) SetDefaults() {
