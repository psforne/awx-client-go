...
ProjectsProjectsObjectRolesListParams contains all the parameters to send to the API endpoint
	...
	for the projects projects object roles list operation.
...
// WithDefaults hydrates default values in the projects projects object roles list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProjectsProjectsObjectRolesListParams) WithDefaults() *ProjectsProjectsObjectRolesListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the projects projects object roles list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProjectsProjectsObjectRolesListParams) SetDefaults() {
