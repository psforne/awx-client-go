...
ProjectsProjectsCopyListParams contains all the parameters to send to the API endpoint
	...
	for the projects projects copy list operation.
...
// WithDefaults hydrates default values in the projects projects copy list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProjectsProjectsCopyListParams) WithDefaults() *ProjectsProjectsCopyListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the projects projects copy list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProjectsProjectsCopyListParams) SetDefaults() {
