...
ProjectsProjectsTeamsListParams contains all the parameters to send to the API endpoint
	...
	for the projects projects teams list operation.
...
// WithDefaults hydrates default values in the projects projects teams list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProjectsProjectsTeamsListParams) WithDefaults() *ProjectsProjectsTeamsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the projects projects teams list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProjectsProjectsTeamsListParams) SetDefaults() {
