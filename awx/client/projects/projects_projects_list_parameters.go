...
ProjectsProjectsListParams contains all the parameters to send to the API endpoint
	...
	for the projects projects list operation.
...
// WithDefaults hydrates default values in the projects projects list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProjectsProjectsListParams) WithDefaults() *ProjectsProjectsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the projects projects list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ProjectsProjectsListParams) SetDefaults() {
