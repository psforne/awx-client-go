...
HostsHostsUpdateParams contains all the parameters to send to the API endpoint
	...
	for the hosts hosts update operation.
...
// WithDefaults hydrates default values in the hosts hosts update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsUpdateParams) WithDefaults() *HostsHostsUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the hosts hosts update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsUpdateParams) SetDefaults() {
