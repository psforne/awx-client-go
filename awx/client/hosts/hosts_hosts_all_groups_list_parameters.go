...
HostsHostsAllGroupsListParams contains all the parameters to send to the API endpoint
	...
	for the hosts hosts all groups list operation.
...
// WithDefaults hydrates default values in the hosts hosts all groups list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsAllGroupsListParams) WithDefaults() *HostsHostsAllGroupsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the hosts hosts all groups list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsAllGroupsListParams) SetDefaults() {
