...
type ClientService interface {
	HostsHostsActivityStreamList(params *HostsHostsActivityStreamListParams, opts ...ClientOption) (*HostsHostsActivityStreamListOK, error)

	HostsHostsAdHocCommandEventsList(params *HostsHostsAdHocCommandEventsListParams, opts ...ClientOption) (*HostsHostsAdHocCommandEventsListOK, error)

	HostsHostsAdHocCommandsCreate(params *HostsHostsAdHocCommandsCreateParams, opts ...ClientOption) (*HostsHostsAdHocCommandsCreateCreated, error)

	HostsHostsAdHocCommandsList(params *HostsHostsAdHocCommandsListParams, opts ...ClientOption) (*HostsHostsAdHocCommandsListOK, error)

	HostsHostsAllGroupsList(params *HostsHostsAllGroupsListParams, opts ...ClientOption) (*HostsHostsAllGroupsListOK, error)

	HostsHostsAnsibleFactsRead(params *HostsHostsAnsibleFactsReadParams, opts ...ClientOption) (*HostsHostsAnsibleFactsReadOK, error)

	HostsHostsCreate(params *HostsHostsCreateParams, opts ...ClientOption) (*HostsHostsCreateCreated, error)

	HostsHostsDelete(params *HostsHostsDeleteParams, opts ...ClientOption) (*HostsHostsDeleteNoContent, error)

	HostsHostsGroupsCreate(params *HostsHostsGroupsCreateParams, opts ...ClientOption) (*HostsHostsGroupsCreateCreated, error)

	HostsHostsGroupsList(params *HostsHostsGroupsListParams, opts ...ClientOption) (*HostsHostsGroupsListOK, error)

	HostsHostsInventorySourcesList(params *HostsHostsInventorySourcesListParams, opts ...ClientOption) (*HostsHostsInventorySourcesListOK, error)

	HostsHostsJobEventsList(params *HostsHostsJobEventsListParams, opts ...ClientOption) (*HostsHostsJobEventsListOK, error)

	HostsHostsJobHostSummariesList(params *HostsHostsJobHostSummariesListParams, opts ...ClientOption) (*HostsHostsJobHostSummariesListOK, error)

	HostsHostsList(params *HostsHostsListParams, opts ...ClientOption) (*HostsHostsListOK, error)

	HostsHostsPartialUpdate(params *HostsHostsPartialUpdateParams, opts ...ClientOption) (*HostsHostsPartialUpdateOK, error)

	HostsHostsRead(params *HostsHostsReadParams, opts ...ClientOption) (*HostsHostsReadOK, error)

	HostsHostsSmartInventoriesList(params *HostsHostsSmartInventoriesListParams, opts ...ClientOption) (*HostsHostsSmartInventoriesListOK, error)

	HostsHostsUpdate(params *HostsHostsUpdateParams, opts ...ClientOption) (*HostsHostsUpdateOK, error)

	HostsHostsVariableDataPartialUpdate(params *HostsHostsVariableDataPartialUpdateParams, opts ...ClientOption) (*HostsHostsVariableDataPartialUpdateOK, error)

	HostsHostsVariableDataRead(params *HostsHostsVariableDataReadParams, opts ...ClientOption) (*HostsHostsVariableDataReadOK, error)

	HostsHostsVariableDataUpdate(params *HostsHostsVariableDataUpdateParams, opts ...ClientOption) (*HostsHostsVariableDataUpdateOK, error)
...
*/
func (a *Client) HostsHostsActivityStreamList(params *HostsHostsActivityStreamListParams, opts ...ClientOption) (*HostsHostsActivityStreamListOK, error) {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) HostsHostsAdHocCommandEventsList(params *HostsHostsAdHocCommandEventsListParams, opts ...ClientOption) (*HostsHostsAdHocCommandEventsListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HostsHostsAdHocCommandsCreate(params *HostsHostsAdHocCommandsCreateParams, opts ...ClientOption) (*HostsHostsAdHocCommandsCreateCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) HostsHostsAdHocCommandsList(params *HostsHostsAdHocCommandsListParams, opts ...ClientOption) (*HostsHostsAdHocCommandsListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) HostsHostsAllGroupsList(params *HostsHostsAllGroupsListParams, opts ...ClientOption) (*HostsHostsAllGroupsListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HostsHostsAnsibleFactsRead(params *HostsHostsAnsibleFactsReadParams, opts ...ClientOption) (*HostsHostsAnsibleFactsReadOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HostsHostsCreate(params *HostsHostsCreateParams, opts ...ClientOption) (*HostsHostsCreateCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HostsHostsDelete(params *HostsHostsDeleteParams, opts ...ClientOption) (*HostsHostsDeleteNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HostsHostsGroupsCreate(params *HostsHostsGroupsCreateParams, opts ...ClientOption) (*HostsHostsGroupsCreateCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) HostsHostsGroupsList(params *HostsHostsGroupsListParams, opts ...ClientOption) (*HostsHostsGroupsListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) HostsHostsInventorySourcesList(params *HostsHostsInventorySourcesListParams, opts ...ClientOption) (*HostsHostsInventorySourcesListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) HostsHostsJobEventsList(params *HostsHostsJobEventsListParams, opts ...ClientOption) (*HostsHostsJobEventsListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) HostsHostsJobHostSummariesList(params *HostsHostsJobHostSummariesListParams, opts ...ClientOption) (*HostsHostsJobHostSummariesListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) HostsHostsList(params *HostsHostsListParams, opts ...ClientOption) (*HostsHostsListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HostsHostsPartialUpdate(params *HostsHostsPartialUpdateParams, opts ...ClientOption) (*HostsHostsPartialUpdateOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
* `ansible_facts_modified`: The date and time ansible_facts was last modified. (datetime)
*/
func (a *Client) HostsHostsRead(params *HostsHostsReadParams, opts ...ClientOption) (*HostsHostsReadOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) HostsHostsSmartInventoriesList(params *HostsHostsSmartInventoriesListParams, opts ...ClientOption) (*HostsHostsSmartInventoriesListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) HostsHostsUpdate(params *HostsHostsUpdateParams, opts ...ClientOption) (*HostsHostsUpdateOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
host.
*/
func (a *Client) HostsHostsVariableDataPartialUpdate(params *HostsHostsVariableDataPartialUpdateParams, opts ...ClientOption) (*HostsHostsVariableDataPartialUpdateOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
host.
*/
func (a *Client) HostsHostsVariableDataRead(params *HostsHostsVariableDataReadParams, opts ...ClientOption) (*HostsHostsVariableDataReadOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
host.
*/
func (a *Client) HostsHostsVariableDataUpdate(params *HostsHostsVariableDataUpdateParams, opts ...ClientOption) (*HostsHostsVariableDataUpdateOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
