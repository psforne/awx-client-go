...
HostsHostsGroupsListParams contains all the parameters to send to the API endpoint
	...
	for the hosts hosts groups list operation.
...
// WithDefaults hydrates default values in the hosts hosts groups list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsGroupsListParams) WithDefaults() *HostsHostsGroupsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the hosts hosts groups list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *HostsHostsGroupsListParams) SetDefaults() {
