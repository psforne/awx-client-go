...
WorkflowJobTemplateNodesWorkflowJobTemplateNodesPartialUpdateParams contains all the parameters to send to the API endpoint
	...
	for the workflow job template nodes workflow job template nodes partial update operation.
...
// WithDefaults hydrates default values in the workflow job template nodes workflow job template nodes partial update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobTemplateNodesWorkflowJobTemplateNodesPartialUpdateParams) WithDefaults() *WorkflowJobTemplateNodesWorkflowJobTemplateNodesPartialUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the workflow job template nodes workflow job template nodes partial update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobTemplateNodesWorkflowJobTemplateNodesPartialUpdateParams) SetDefaults() {
