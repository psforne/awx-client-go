...
TeamsTeamsListParams contains all the parameters to send to the API endpoint
	...
	for the teams teams list operation.
...
// WithDefaults hydrates default values in the teams teams list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsListParams) WithDefaults() *TeamsTeamsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the teams teams list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsListParams) SetDefaults() {
