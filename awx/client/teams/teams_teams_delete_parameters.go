...
TeamsTeamsDeleteParams contains all the parameters to send to the API endpoint
	...
	for the teams teams delete operation.
...
// WithDefaults hydrates default values in the teams teams delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsDeleteParams) WithDefaults() *TeamsTeamsDeleteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the teams teams delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsDeleteParams) SetDefaults() {
