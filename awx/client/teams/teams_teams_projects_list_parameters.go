...
TeamsTeamsProjectsListParams contains all the parameters to send to the API endpoint
	...
	for the teams teams projects list operation.
...
// WithDefaults hydrates default values in the teams teams projects list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsProjectsListParams) WithDefaults() *TeamsTeamsProjectsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the teams teams projects list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsProjectsListParams) SetDefaults() {
