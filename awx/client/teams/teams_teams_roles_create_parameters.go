...
TeamsTeamsRolesCreateParams contains all the parameters to send to the API endpoint
	...
	for the teams teams roles create operation.
...
// WithDefaults hydrates default values in the teams teams roles create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsRolesCreateParams) WithDefaults() *TeamsTeamsRolesCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the teams teams roles create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsRolesCreateParams) SetDefaults() {
