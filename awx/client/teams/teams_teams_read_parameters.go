...
TeamsTeamsReadParams contains all the parameters to send to the API endpoint
	...
	for the teams teams read operation.
...
// WithDefaults hydrates default values in the teams teams read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsReadParams) WithDefaults() *TeamsTeamsReadParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the teams teams read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsReadParams) SetDefaults() {
