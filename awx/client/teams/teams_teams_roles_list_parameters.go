...
TeamsTeamsRolesListParams contains all the parameters to send to the API endpoint
	...
	for the teams teams roles list operation.
...
// WithDefaults hydrates default values in the teams teams roles list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsRolesListParams) WithDefaults() *TeamsTeamsRolesListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the teams teams roles list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *TeamsTeamsRolesListParams) SetDefaults() {
