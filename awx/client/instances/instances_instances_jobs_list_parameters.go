...
InstancesInstancesJobsListParams contains all the parameters to send to the API endpoint
	...
	for the instances instances jobs list operation.
...
// WithDefaults hydrates default values in the instances instances jobs list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InstancesInstancesJobsListParams) WithDefaults() *InstancesInstancesJobsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the instances instances jobs list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InstancesInstancesJobsListParams) SetDefaults() {
