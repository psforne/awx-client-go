...
WorkflowJobNodesWorkflowJobNodesCredentialsListParams contains all the parameters to send to the API endpoint
	...
	for the workflow job nodes workflow job nodes credentials list operation.
...
// WithDefaults hydrates default values in the workflow job nodes workflow job nodes credentials list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobNodesWorkflowJobNodesCredentialsListParams) WithDefaults() *WorkflowJobNodesWorkflowJobNodesCredentialsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the workflow job nodes workflow job nodes credentials list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobNodesWorkflowJobNodesCredentialsListParams) SetDefaults() {
