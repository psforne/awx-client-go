...
WorkflowJobsWorkflowJobsWorkflowNodesListParams contains all the parameters to send to the API endpoint
	...
	for the workflow jobs workflow jobs workflow nodes list operation.
...
// WithDefaults hydrates default values in the workflow jobs workflow jobs workflow nodes list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobsWorkflowJobsWorkflowNodesListParams) WithDefaults() *WorkflowJobsWorkflowJobsWorkflowNodesListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the workflow jobs workflow jobs workflow nodes list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *WorkflowJobsWorkflowJobsWorkflowNodesListParams) SetDefaults() {
