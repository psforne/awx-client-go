...
SettingsSettingsLoggingTestCreateParams contains all the parameters to send to the API endpoint
	...
	for the settings settings logging test create operation.
...
// WithDefaults hydrates default values in the settings settings logging test create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SettingsSettingsLoggingTestCreateParams) WithDefaults() *SettingsSettingsLoggingTestCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the settings settings logging test create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SettingsSettingsLoggingTestCreateParams) SetDefaults() {
