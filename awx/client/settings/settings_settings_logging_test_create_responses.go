...
/*
SettingsSettingsLoggingTestCreateCreated describes a response with status code 201, with default header values.
...
// IsSuccess returns true when this settings settings logging test create created response has a 2xx status code
func (o *SettingsSettingsLoggingTestCreateCreated) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this settings settings logging test create created response has a 3xx status code
func (o *SettingsSettingsLoggingTestCreateCreated) IsRedirect() bool {
	return false
}

// IsClientError returns true when this settings settings logging test create created response has a 4xx status code
func (o *SettingsSettingsLoggingTestCreateCreated) IsClientError() bool {
	return false
}

// IsServerError returns true when this settings settings logging test create created response has a 5xx status code
func (o *SettingsSettingsLoggingTestCreateCreated) IsServerError() bool {
	return false
}

// IsCode returns true when this settings settings logging test create created response a status code equal to that given
func (o *SettingsSettingsLoggingTestCreateCreated) IsCode(code int) bool {
	return code == 201
}
...
func (o *SettingsSettingsLoggingTestCreateCreated) String() string {
	return fmt.Sprintf("[POST /api/v2/settings/logging/test/][%d] settingsSettingsLoggingTestCreateCreated ", 201)
}
...
/*
SettingsSettingsLoggingTestCreateForbidden describes a response with status code 403, with default header values.
...
// IsSuccess returns true when this settings settings logging test create forbidden response has a 2xx status code
func (o *SettingsSettingsLoggingTestCreateForbidden) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this settings settings logging test create forbidden response has a 3xx status code
func (o *SettingsSettingsLoggingTestCreateForbidden) IsRedirect() bool {
	return false
}

// IsClientError returns true when this settings settings logging test create forbidden response has a 4xx status code
func (o *SettingsSettingsLoggingTestCreateForbidden) IsClientError() bool {
	return true
}

// IsServerError returns true when this settings settings logging test create forbidden response has a 5xx status code
func (o *SettingsSettingsLoggingTestCreateForbidden) IsServerError() bool {
	return false
}

// IsCode returns true when this settings settings logging test create forbidden response a status code equal to that given
func (o *SettingsSettingsLoggingTestCreateForbidden) IsCode(code int) bool {
	return code == 403
}
...
func (o *SettingsSettingsLoggingTestCreateForbidden) String() string {
	return fmt.Sprintf("[POST /api/v2/settings/logging/test/][%d] settingsSettingsLoggingTestCreateForbidden ", 403)
}
...
/*
SettingsSettingsLoggingTestCreateConflict describes a response with status code 409, with default header values.

SettingsSettingsLoggingTestCreateConflict settings settings logging test create conflict
*/
type SettingsSettingsLoggingTestCreateConflict struct {
}

// IsSuccess returns true when this settings settings logging test create conflict response has a 2xx status code
func (o *SettingsSettingsLoggingTestCreateConflict) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this settings settings logging test create conflict response has a 3xx status code
func (o *SettingsSettingsLoggingTestCreateConflict) IsRedirect() bool {
	return false
}

// IsClientError returns true when this settings settings logging test create conflict response has a 4xx status code
func (o *SettingsSettingsLoggingTestCreateConflict) IsClientError() bool {
	return true
}

// IsServerError returns true when this settings settings logging test create conflict response has a 5xx status code
func (o *SettingsSettingsLoggingTestCreateConflict) IsServerError() bool {
	return false
}

// IsCode returns true when this settings settings logging test create conflict response a status code equal to that given
func (o *SettingsSettingsLoggingTestCreateConflict) IsCode(code int) bool {
	return code == 409
}
...
func (o *SettingsSettingsLoggingTestCreateConflict) String() string {
	return fmt.Sprintf("[POST /api/v2/settings/logging/test/][%d] settingsSettingsLoggingTestCreateConflict ", 409)
}
...
type SettingsSettingsLoggingTestCreateBody struct {
	...
	// a u t o m a t i o n a n a l y t i c s l a s t e n t r i e s
	AUTOMATIONANALYTICSLASTENTRIES string `json:"AUTOMATION_ANALYTICS_LAST_ENTRIES,omitempty"`
	...
	// Required: true
	AWXISOLATIONBASEPATH *string `json:"AWX_ISOLATION_BASE_PATH"`

	// List of paths that would otherwise be hidden to expose to isolated jobs. Enter one path per line.
	AWXISOLATIONSHOWPATHS []string `json:"AWX_ISOLATION_SHOW_PATHS"`
	...
	AWXSHOWPLAYBOOKLINKS bool `json:"AWX_SHOW_PLAYBOOK_LINKS,omitempty"`
	...
	DEFAULTEXECUTIONENVIRONMENT int64 `json:"DEFAULT_EXECUTION_ENVIRONMENT,omitempty"`
	...
	MAXWEBSOCKETEVENTRATE int64 `json:"MAX_WEBSOCKET_EVENT_RATE,omitempty"`
	...
	// Required: true
	PROXYIPALLOWEDLIST []string `json:"PROXY_IP_ALLOWED_LIST"`
	...
	SAMLAUTOCREATEOBJECTS bool `json:"SAML_AUTO_CREATE_OBJECTS,omitempty"`
	...
	SOCIALAUTHGITHUBENTERPRISEAPIURL string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_API_URL,omitempty"`

	// The OAuth2 key (Client ID) from your GitHub Enterprise developer application.
	SOCIALAUTHGITHUBENTERPRISEKEY string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_KEY,omitempty"`

	// Mapping to organization admins/users from social auth accounts. This setting
	// controls which users are placed into which organizations based on their
	// username and email address. Configuration details are available in the
	// documentation.
	SOCIALAUTHGITHUBENTERPRISEORGANIZATIONMAP interface{} `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORGANIZATION_MAP,omitempty"`

	// The API URL for your GitHub Enterprise instance, e.g.: http(s)://hostname/api/v3/. Refer to Github Enterprise documentation for more details.
	SOCIALAUTHGITHUBENTERPRISEORGAPIURL string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_API_URL,omitempty"`

	// The OAuth2 key (Client ID) from your GitHub Enterprise organization application.
	SOCIALAUTHGITHUBENTERPRISEORGKEY string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_KEY,omitempty"`

	// The name of your GitHub Enterprise organization, as used in your organization's URL: https://github.com/<yourorg>/.
	SOCIALAUTHGITHUBENTERPRISEORGNAME string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_NAME,omitempty"`

	// Mapping to organization admins/users from social auth accounts. This setting
	// controls which users are placed into which organizations based on their
	// username and email address. Configuration details are available in the
	// documentation.
	SOCIALAUTHGITHUBENTERPRISEORGORGANIZATIONMAP interface{} `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_ORGANIZATION_MAP,omitempty"`

	// The OAuth2 secret (Client Secret) from your GitHub Enterprise organization application.
	SOCIALAUTHGITHUBENTERPRISEORGSECRET string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_SECRET,omitempty"`

	// Mapping of team members (users) from social auth accounts. Configuration
	// details are available in the documentation.
	SOCIALAUTHGITHUBENTERPRISEORGTEAMMAP interface{} `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_TEAM_MAP,omitempty"`
	...
	SOCIALAUTHGITHUBENTERPRISEORGURL string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_URL,omitempty"`

	// The OAuth2 secret (Client Secret) from your GitHub Enterprise developer application.
	SOCIALAUTHGITHUBENTERPRISESECRET string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_SECRET,omitempty"`

	// The API URL for your GitHub Enterprise instance, e.g.: http(s)://hostname/api/v3/. Refer to Github Enterprise documentation for more details.
	SOCIALAUTHGITHUBENTERPRISETEAMAPIURL string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_API_URL,omitempty"`
	...
	SOCIALAUTHGITHUBENTERPRISETEAMID string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_ID,omitempty"`

	// The OAuth2 key (Client ID) from your GitHub Enterprise organization application.
	SOCIALAUTHGITHUBENTERPRISETEAMKEY string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_KEY,omitempty"`

	// Mapping of team members (users) from social auth accounts. Configuration
	// details are available in the documentation.
	SOCIALAUTHGITHUBENTERPRISETEAMMAP interface{} `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_MAP,omitempty"`

	// Mapping to organization admins/users from social auth accounts. This setting
	// controls which users are placed into which organizations based on their
	// username and email address. Configuration details are available in the
	// documentation.
	SOCIALAUTHGITHUBENTERPRISETEAMORGANIZATIONMAP interface{} `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_ORGANIZATION_MAP,omitempty"`

	// The OAuth2 secret (Client Secret) from your GitHub Enterprise organization application.
	SOCIALAUTHGITHUBENTERPRISETEAMSECRET string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_SECRET,omitempty"`

	// Mapping of team members (users) from social auth accounts. Configuration
	// details are available in the documentation.
	SOCIALAUTHGITHUBENTERPRISETEAMTEAMMAP interface{} `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_TEAM_MAP,omitempty"`

	// The URL for your Github Enterprise instance, e.g.: http(s)://hostname/. Refer to Github Enterprise documentation for more details.
	SOCIALAUTHGITHUBENTERPRISETEAMURL string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_URL,omitempty"`

	// The URL for your Github Enterprise instance, e.g.: http(s)://hostname/. Refer to Github Enterprise documentation for more details.
	SOCIALAUTHGITHUBENTERPRISEURL string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_URL,omitempty"`
	...
	SUBSCRIPTIONSPASSWORD string `json:"SUBSCRIPTIONS_PASSWORD,omitempty"`

	// This username is used to retrieve subscription and content information
	SUBSCRIPTIONSUSERNAME string `json:"SUBSCRIPTIONS_USERNAME,omitempty"`
...
func (o *SettingsSettingsLoggingTestCreateBody) Validate(formats strfmt.Registry) error {
	...
	if err := o.validateAWXISOLATIONBASEPATH(formats); err != nil {
		res = append(res, err)
	}

	if err := o.validateDISABLELOCALAUTH(formats); err != nil {
		res = append(res, err)
	}
	...
	if err := o.validatePROXYIPALLOWEDLIST(formats); err != nil {
		res = append(res, err)
	}
...
func (o *SettingsSettingsLoggingTestCreateBody) validateAWXISOLATIONBASEPATH(formats strfmt.Registry) error {

	if err := validate.Required("data"+"."+"AWX_ISOLATION_BASE_PATH", "body", o.AWXISOLATIONBASEPATH); err != nil {
		return err
	}
...
func (o *SettingsSettingsLoggingTestCreateBody) validateDISABLELOCALAUTH(formats strfmt.Registry) error {

	if err := validate.Required("data"+"."+"DISABLE_LOCAL_AUTH", "body", o.DISABLELOCALAUTH); err != nil {
		return err
	}
...
func (o *SettingsSettingsLoggingTestCreateBody) validatePROXYIPALLOWEDLIST(formats strfmt.Registry) error {

	if err := validate.Required("data"+"."+"PROXY_IP_ALLOWED_LIST", "body", o.PROXYIPALLOWEDLIST); err != nil {
		return err
	}
...
func (o *SettingsSettingsLoggingTestCreateBody) validateSOCIALAUTHSAMLORGINFO(formats strfmt.Registry) error {
	...
	if o.SOCIALAUTHSAMLORGINFO == nil {
		return errors.Required("data"+"."+"SOCIAL_AUTH_SAML_ORG_INFO", "body", nil)
	}
...
func (o *SettingsSettingsLoggingTestCreateBody) validateSOCIALAUTHSAMLSUPPORTCONTACT(formats strfmt.Registry) error {
	...
	if o.SOCIALAUTHSAMLSUPPORTCONTACT == nil {
		return errors.Required("data"+"."+"SOCIAL_AUTH_SAML_SUPPORT_CONTACT", "body", nil)
	}
...
func (o *SettingsSettingsLoggingTestCreateBody) validateSOCIALAUTHSAMLTECHNICALCONTACT(formats strfmt.Registry) error {
	...
	if o.SOCIALAUTHSAMLTECHNICALCONTACT == nil {
		return errors.Required("data"+"."+"SOCIAL_AUTH_SAML_TECHNICAL_CONTACT", "body", nil)
	}
...
// ContextValidate validates this settings settings logging test create body based on context it is used
func (o *SettingsSettingsLoggingTestCreateBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
