...
SettingsSettingsPartialUpdateParams contains all the parameters to send to the API endpoint
	...
	for the settings settings partial update operation.
...
// WithDefaults hydrates default values in the settings settings partial update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SettingsSettingsPartialUpdateParams) WithDefaults() *SettingsSettingsPartialUpdateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the settings settings partial update params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SettingsSettingsPartialUpdateParams) SetDefaults() {
