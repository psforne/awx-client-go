...
type ClientService interface {
	SettingsSettingsDelete(params *SettingsSettingsDeleteParams, opts ...ClientOption) (*SettingsSettingsDeleteNoContent, error)

	SettingsSettingsList(params *SettingsSettingsListParams, opts ...ClientOption) (*SettingsSettingsListOK, error)

	SettingsSettingsLoggingTestCreate(params *SettingsSettingsLoggingTestCreateParams, opts ...ClientOption) (*SettingsSettingsLoggingTestCreateCreated, error)

	SettingsSettingsPartialUpdate(params *SettingsSettingsPartialUpdateParams, opts ...ClientOption) (*SettingsSettingsPartialUpdateOK, error)

	SettingsSettingsRead(params *SettingsSettingsReadParams, opts ...ClientOption) (*SettingsSettingsReadOK, error)

	SettingsSettingsUpdate(params *SettingsSettingsUpdateParams, opts ...ClientOption) (*SettingsSettingsUpdateOK, error)
...
*/
func (a *Client) SettingsSettingsDelete(params *SettingsSettingsDeleteParams, opts ...ClientOption) (*SettingsSettingsDeleteNoContent, error) {
...
*/
func (a *Client) SettingsSettingsList(params *SettingsSettingsListParams, opts ...ClientOption) (*SettingsSettingsListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SettingsSettingsLoggingTestCreate(params *SettingsSettingsLoggingTestCreateParams, opts ...ClientOption) (*SettingsSettingsLoggingTestCreateCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
* `REDHAT_USERNAME`: This username is used to send data to Insights for Ansible Automation Platform (string, default=`""`)
...
* `AUTOMATION_ANALYTICS_URL`: This setting is used to to configure the upload URL for data collection for Red Hat Insights. (string, default=`"https://example.com"`)
...
* `AWX_ISOLATION_SHOW_PATHS`: List of paths that would otherwise be hidden to expose to isolated jobs. Enter one path per line. (list, default=`[]`)
...
* `INSIGHTS_TRACKING_STATE`: Enables the service to gather data on automation and send it to Red Hat Insights. (boolean, default=`False`)
...
*/
func (a *Client) SettingsSettingsPartialUpdate(params *SettingsSettingsPartialUpdateParams, opts ...ClientOption) (*SettingsSettingsPartialUpdateOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
* `REDHAT_USERNAME`: This username is used to send data to Insights for Ansible Automation Platform (string)
* `REDHAT_PASSWORD`: This password is used to send data to Insights for Ansible Automation Platform (string)
...
* `AUTOMATION_ANALYTICS_URL`: This setting is used to to configure the upload URL for data collection for Red Hat Insights. (string)
* `INSTALL_UUID`:  (string)
...
* `AWX_ISOLATION_SHOW_PATHS`: List of paths that would otherwise be hidden to expose to isolated jobs. Enter one path per line. (list)
...
* `INSIGHTS_TRACKING_STATE`: Enables the service to gather data on automation and send it to Red Hat Insights. (boolean)
...
*/
func (a *Client) SettingsSettingsRead(params *SettingsSettingsReadParams, opts ...ClientOption) (*SettingsSettingsReadOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) SettingsSettingsUpdate(params *SettingsSettingsUpdateParams, opts ...ClientOption) (*SettingsSettingsUpdateOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
