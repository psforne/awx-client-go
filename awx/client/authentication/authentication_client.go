...
type ClientService interface {
	AuthenticationApplicationsActivityStreamList(params *AuthenticationApplicationsActivityStreamListParams, opts ...ClientOption) (*AuthenticationApplicationsActivityStreamListOK, error)

	AuthenticationApplicationsCreate0(params *AuthenticationApplicationsCreate0Params, opts ...ClientOption) (*AuthenticationApplicationsCreate0Created, error)

	AuthenticationApplicationsDelete0(params *AuthenticationApplicationsDelete0Params, opts ...ClientOption) (*AuthenticationApplicationsDelete0NoContent, error)

	AuthenticationApplicationsList0(params *AuthenticationApplicationsList0Params, opts ...ClientOption) (*AuthenticationApplicationsList0OK, error)

	AuthenticationApplicationsPartialUpdate0(params *AuthenticationApplicationsPartialUpdate0Params, opts ...ClientOption) (*AuthenticationApplicationsPartialUpdate0OK, error)

	AuthenticationApplicationsRead0(params *AuthenticationApplicationsRead0Params, opts ...ClientOption) (*AuthenticationApplicationsRead0OK, error)

	AuthenticationApplicationsTokensCreate0(params *AuthenticationApplicationsTokensCreate0Params, opts ...ClientOption) (*AuthenticationApplicationsTokensCreate0Created, error)

	AuthenticationApplicationsTokensList0(params *AuthenticationApplicationsTokensList0Params, opts ...ClientOption) (*AuthenticationApplicationsTokensList0OK, error)

	AuthenticationApplicationsUpdate0(params *AuthenticationApplicationsUpdate0Params, opts ...ClientOption) (*AuthenticationApplicationsUpdate0OK, error)

	AuthenticationoList(params *AuthenticationoListParams, opts ...ClientOption) (*AuthenticationOListOK, error)

	AuthenticationTokensActivityStreamList(params *AuthenticationTokensActivityStreamListParams, opts ...ClientOption) (*AuthenticationTokensActivityStreamListOK, error)

	AuthenticationTokensCreate0(params *AuthenticationTokensCreate0Params, opts ...ClientOption) (*AuthenticationTokensCreate0Created, error)

	AuthenticationTokensDelete(params *AuthenticationTokensDeleteParams, opts ...ClientOption) (*AuthenticationTokensDeleteNoContent, error)

	AuthenticationTokensList0(params *AuthenticationTokensList0Params, opts ...ClientOption) (*AuthenticationTokensList0OK, error)

	AuthenticationTokensPartialUpdate(params *AuthenticationTokensPartialUpdateParams, opts ...ClientOption) (*AuthenticationTokensPartialUpdateOK, error)

	AuthenticationTokensRead(params *AuthenticationTokensReadParams, opts ...ClientOption) (*AuthenticationTokensReadOK, error)

	AuthenticationTokensUpdate(params *AuthenticationTokensUpdateParams, opts ...ClientOption) (*AuthenticationTokensUpdateOK, error)
...
*/
func (a *Client) AuthenticationApplicationsActivityStreamList(params *AuthenticationApplicationsActivityStreamListParams, opts ...ClientOption) (*AuthenticationApplicationsActivityStreamListOK, error) {
...
*/
func (a *Client) AuthenticationApplicationsCreate0(params *AuthenticationApplicationsCreate0Params, opts ...ClientOption) (*AuthenticationApplicationsCreate0Created, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) AuthenticationApplicationsDelete0(params *AuthenticationApplicationsDelete0Params, opts ...ClientOption) (*AuthenticationApplicationsDelete0NoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) AuthenticationApplicationsList0(params *AuthenticationApplicationsList0Params, opts ...ClientOption) (*AuthenticationApplicationsList0OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) AuthenticationApplicationsPartialUpdate0(params *AuthenticationApplicationsPartialUpdate0Params, opts ...ClientOption) (*AuthenticationApplicationsPartialUpdate0OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
* `organization`: Organization containing this application. (id)
*/
func (a *Client) AuthenticationApplicationsRead0(params *AuthenticationApplicationsRead0Params, opts ...ClientOption) (*AuthenticationApplicationsRead0OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) AuthenticationApplicationsTokensCreate0(params *AuthenticationApplicationsTokensCreate0Params, opts ...ClientOption) (*AuthenticationApplicationsTokensCreate0Created, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) AuthenticationApplicationsTokensList0(params *AuthenticationApplicationsTokensList0Params, opts ...ClientOption) (*AuthenticationApplicationsTokensList0OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) AuthenticationApplicationsUpdate0(params *AuthenticationApplicationsUpdate0Params, opts ...ClientOption) (*AuthenticationApplicationsUpdate0OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) AuthenticationoList(params *AuthenticationoListParams, opts ...ClientOption) (*AuthenticationOListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) AuthenticationTokensActivityStreamList(params *AuthenticationTokensActivityStreamListParams, opts ...ClientOption) (*AuthenticationTokensActivityStreamListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
* `scope`: Allowed scopes, further restricts user&#39;s permissions. Must be a simple space-separated string with allowed scopes [&#39;read&#39;, &#39;write&#39;]. (string, default=`"write"`)
*/
func (a *Client) AuthenticationTokensCreate0(params *AuthenticationTokensCreate0Params, opts ...ClientOption) (*AuthenticationTokensCreate0Created, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
*/
func (a *Client) AuthenticationTokensDelete(params *AuthenticationTokensDeleteParams, opts ...ClientOption) (*AuthenticationTokensDeleteNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
(_Added in Ansible Tower 3.1.0_) Search across related fields:
	...
	?related__search=findme
*/
func (a *Client) AuthenticationTokensList0(params *AuthenticationTokensList0Params, opts ...ClientOption) (*AuthenticationTokensList0OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
For a PATCH request, include only the fields that are being modified.
*/
func (a *Client) AuthenticationTokensPartialUpdate(params *AuthenticationTokensPartialUpdateParams, opts ...ClientOption) (*AuthenticationTokensPartialUpdateOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
* `scope`: Allowed scopes, further restricts user&#39;s permissions. Must be a simple space-separated string with allowed scopes [&#39;read&#39;, &#39;write&#39;]. (string)
*/
func (a *Client) AuthenticationTokensRead(params *AuthenticationTokensReadParams, opts ...ClientOption) (*AuthenticationTokensReadOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
...
For a PUT request, include **all** fields in the request.
*/
func (a *Client) AuthenticationTokensUpdate(params *AuthenticationTokensUpdateParams, opts ...ClientOption) (*AuthenticationTokensUpdateOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
