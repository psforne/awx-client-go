...
SchedulesSchedulesCreateParams contains all the parameters to send to the API endpoint
	...
	for the schedules schedules create operation.
...
// WithDefaults hydrates default values in the schedules schedules create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SchedulesSchedulesCreateParams) WithDefaults() *SchedulesSchedulesCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the schedules schedules create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SchedulesSchedulesCreateParams) SetDefaults() {
