...
SchedulesSchedulesReadParams contains all the parameters to send to the API endpoint
	...
	for the schedules schedules read operation.
...
// WithDefaults hydrates default values in the schedules schedules read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SchedulesSchedulesReadParams) WithDefaults() *SchedulesSchedulesReadParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the schedules schedules read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SchedulesSchedulesReadParams) SetDefaults() {
