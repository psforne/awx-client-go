...
InventorySourcesInventorySourcesGroupsDeleteParams contains all the parameters to send to the API endpoint
	...
	for the inventory sources inventory sources groups delete operation.
...
// WithDefaults hydrates default values in the inventory sources inventory sources groups delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InventorySourcesInventorySourcesGroupsDeleteParams) WithDefaults() *InventorySourcesInventorySourcesGroupsDeleteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the inventory sources inventory sources groups delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InventorySourcesInventorySourcesGroupsDeleteParams) SetDefaults() {
