...
/*
InventorySourcesInventorySourcesCredentialsCreateCreated describes a response with status code 201, with default header values.
...
// IsSuccess returns true when this inventory sources inventory sources credentials create created response has a 2xx status code
func (o *InventorySourcesInventorySourcesCredentialsCreateCreated) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this inventory sources inventory sources credentials create created response has a 3xx status code
func (o *InventorySourcesInventorySourcesCredentialsCreateCreated) IsRedirect() bool {
	return false
}

// IsClientError returns true when this inventory sources inventory sources credentials create created response has a 4xx status code
func (o *InventorySourcesInventorySourcesCredentialsCreateCreated) IsClientError() bool {
	return false
}

// IsServerError returns true when this inventory sources inventory sources credentials create created response has a 5xx status code
func (o *InventorySourcesInventorySourcesCredentialsCreateCreated) IsServerError() bool {
	return false
}

// IsCode returns true when this inventory sources inventory sources credentials create created response a status code equal to that given
func (o *InventorySourcesInventorySourcesCredentialsCreateCreated) IsCode(code int) bool {
	return code == 201
}
...
func (o *InventorySourcesInventorySourcesCredentialsCreateCreated) String() string {
	return fmt.Sprintf("[POST /api/v2/inventory_sources/{id}/credentials/][%d] inventorySourcesInventorySourcesCredentialsCreateCreated ", 201)
}
...
/*
InventorySourcesInventorySourcesCredentialsCreateBadRequest describes a response with status code 400, with default header values.
...
// IsSuccess returns true when this inventory sources inventory sources credentials create bad request response has a 2xx status code
func (o *InventorySourcesInventorySourcesCredentialsCreateBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this inventory sources inventory sources credentials create bad request response has a 3xx status code
func (o *InventorySourcesInventorySourcesCredentialsCreateBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this inventory sources inventory sources credentials create bad request response has a 4xx status code
func (o *InventorySourcesInventorySourcesCredentialsCreateBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this inventory sources inventory sources credentials create bad request response has a 5xx status code
func (o *InventorySourcesInventorySourcesCredentialsCreateBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this inventory sources inventory sources credentials create bad request response a status code equal to that given
func (o *InventorySourcesInventorySourcesCredentialsCreateBadRequest) IsCode(code int) bool {
	return code == 400
}
...
func (o *InventorySourcesInventorySourcesCredentialsCreateBadRequest) String() string {
	return fmt.Sprintf("[POST /api/v2/inventory_sources/{id}/credentials/][%d] inventorySourcesInventorySourcesCredentialsCreateBadRequest ", 400)
}
...
// ContextValidate validates this inventory sources inventory sources credentials create body based on context it is used
func (o *InventorySourcesInventorySourcesCredentialsCreateBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
