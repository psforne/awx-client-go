...
GroupsGroupsJobEventsListParams contains all the parameters to send to the API endpoint
	...
	for the groups groups job events list operation.
...
// WithDefaults hydrates default values in the groups groups job events list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GroupsGroupsJobEventsListParams) WithDefaults() *GroupsGroupsJobEventsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the groups groups job events list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GroupsGroupsJobEventsListParams) SetDefaults() {
