...
GroupsGroupsChildrenListParams contains all the parameters to send to the API endpoint
	...
	for the groups groups children list operation.
...
// WithDefaults hydrates default values in the groups groups children list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GroupsGroupsChildrenListParams) WithDefaults() *GroupsGroupsChildrenListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the groups groups children list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GroupsGroupsChildrenListParams) SetDefaults() {
