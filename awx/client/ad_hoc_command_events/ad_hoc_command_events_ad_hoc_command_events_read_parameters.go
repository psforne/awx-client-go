...
AdHocCommandEventsAdHocCommandEventsReadParams contains all the parameters to send to the API endpoint
	...
	for the ad hoc command events ad hoc command events read operation.
...
// WithDefaults hydrates default values in the ad hoc command events ad hoc command events read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AdHocCommandEventsAdHocCommandEventsReadParams) WithDefaults() *AdHocCommandEventsAdHocCommandEventsReadParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the ad hoc command events ad hoc command events read params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *AdHocCommandEventsAdHocCommandEventsReadParams) SetDefaults() {
