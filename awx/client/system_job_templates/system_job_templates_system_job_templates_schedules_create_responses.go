...
/*
SystemJobTemplatesSystemJobTemplatesSchedulesCreateCreated describes a response with status code 201, with default header values.
...
// IsSuccess returns true when this system job templates system job templates schedules create created response has a 2xx status code
func (o *SystemJobTemplatesSystemJobTemplatesSchedulesCreateCreated) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this system job templates system job templates schedules create created response has a 3xx status code
func (o *SystemJobTemplatesSystemJobTemplatesSchedulesCreateCreated) IsRedirect() bool {
	return false
}

// IsClientError returns true when this system job templates system job templates schedules create created response has a 4xx status code
func (o *SystemJobTemplatesSystemJobTemplatesSchedulesCreateCreated) IsClientError() bool {
	return false
}

// IsServerError returns true when this system job templates system job templates schedules create created response has a 5xx status code
func (o *SystemJobTemplatesSystemJobTemplatesSchedulesCreateCreated) IsServerError() bool {
	return false
}

// IsCode returns true when this system job templates system job templates schedules create created response a status code equal to that given
func (o *SystemJobTemplatesSystemJobTemplatesSchedulesCreateCreated) IsCode(code int) bool {
	return code == 201
}
...
func (o *SystemJobTemplatesSystemJobTemplatesSchedulesCreateCreated) String() string {
	return fmt.Sprintf("[POST /api/v2/system_job_templates/{id}/schedules/][%d] systemJobTemplatesSystemJobTemplatesSchedulesCreateCreated ", 201)
}
...
// ContextValidate validates this system job templates system job templates schedules create body based on context it is used
func (o *SystemJobTemplatesSystemJobTemplatesSchedulesCreateBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
