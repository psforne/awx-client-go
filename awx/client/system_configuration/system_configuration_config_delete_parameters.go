...
SystemConfigurationConfigDeleteParams contains all the parameters to send to the API endpoint
	...
	for the system configuration config delete operation.
...
// WithDefaults hydrates default values in the system configuration config delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SystemConfigurationConfigDeleteParams) WithDefaults() *SystemConfigurationConfigDeleteParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the system configuration config delete params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SystemConfigurationConfigDeleteParams) SetDefaults() {
