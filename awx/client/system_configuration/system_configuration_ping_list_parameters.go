...
SystemConfigurationPingListParams contains all the parameters to send to the API endpoint
	...
	for the system configuration ping list operation.
...
// WithDefaults hydrates default values in the system configuration ping list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SystemConfigurationPingListParams) WithDefaults() *SystemConfigurationPingListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the system configuration ping list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *SystemConfigurationPingListParams) SetDefaults() {
