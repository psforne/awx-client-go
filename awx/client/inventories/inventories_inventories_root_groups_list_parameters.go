...
InventoriesInventoriesRootGroupsListParams contains all the parameters to send to the API endpoint
	...
	for the inventories inventories root groups list operation.
...
// WithDefaults hydrates default values in the inventories inventories root groups list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InventoriesInventoriesRootGroupsListParams) WithDefaults() *InventoriesInventoriesRootGroupsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the inventories inventories root groups list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InventoriesInventoriesRootGroupsListParams) SetDefaults() {
