...
InventoriesInventoriesGroupsCreateParams contains all the parameters to send to the API endpoint
	...
	for the inventories inventories groups create operation.
...
// WithDefaults hydrates default values in the inventories inventories groups create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InventoriesInventoriesGroupsCreateParams) WithDefaults() *InventoriesInventoriesGroupsCreateParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the inventories inventories groups create params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InventoriesInventoriesGroupsCreateParams) SetDefaults() {
