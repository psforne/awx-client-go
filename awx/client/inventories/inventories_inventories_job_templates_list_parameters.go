...
InventoriesInventoriesJobTemplatesListParams contains all the parameters to send to the API endpoint
	...
	for the inventories inventories job templates list operation.
...
// WithDefaults hydrates default values in the inventories inventories job templates list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InventoriesInventoriesJobTemplatesListParams) WithDefaults() *InventoriesInventoriesJobTemplatesListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the inventories inventories job templates list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *InventoriesInventoriesJobTemplatesListParams) SetDefaults() {
