...
UsersUsersApplicationsListParams contains all the parameters to send to the API endpoint
	...
	for the users users applications list operation.
...
// WithDefaults hydrates default values in the users users applications list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersApplicationsListParams) WithDefaults() *UsersUsersApplicationsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the users users applications list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersApplicationsListParams) SetDefaults() {
