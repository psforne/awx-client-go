...
UsersUsersProjectsListParams contains all the parameters to send to the API endpoint
	...
	for the users users projects list operation.
...
// WithDefaults hydrates default values in the users users projects list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersProjectsListParams) WithDefaults() *UsersUsersProjectsListParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the users users projects list params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *UsersUsersProjectsListParams) SetDefaults() {
